...
public class Constants {
    ...
    public static class Projectiles{
        ...
        public static final float SPEED = (int)(0.75f * Game.SCALE);
    }
    ...
    public static class ObjectConstants{
        ...
        public static final int CANNON_HEIGHT_DEFAULT = 26; //IMG IS 40X26
    ...
    public static class EnemyConstants {
        ...
        public static final int CRABBY_DRAWOFFSET_X = (int)(26 * Game.SCALE); //26 AND 9 IS THE DIFFERENCE BETWEE THE START OF THE SPRITE TO THE START OF THE HITBOX
        ...
        public static int GetEnemyDmg(int enemyType){
            switch(enemyType){
                case CRABBY:
                    return 15; //enemys attackbox overlaps players hitbox, player - 15 health.
                default:
                    return 0;
            }
        }
    ...
    public static class PlayerConstants{
        ...
        public static int GetSpriteAmount(int player_action){
            ...
            switch(player_action) { //no of sprites for each action as sen in player_sprites
                case DEAD:
                    return 8;
                case RUNNING:
                    return 6;
